...
const TermsAndConditions = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Dan and Nat Design.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Dan and Nat Design, accessible
            from{" "}
            <a
              href="danandnatdesign.com"
      ...
      <ul>
        <li>By email: danandnat@danandnatdesign.com</li>
      </ul>
    </div>
  );
};
